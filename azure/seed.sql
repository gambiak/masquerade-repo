-- Masquerade V7 Azure beta seed. Editorially review before public launch.
with inserted as (
 insert into puzzles(clue_type,clue_text,answer,difficulty_score,difficulty_band,hint_1,hint_2,hint_3,explanation,is_final_mask,status,numeric_answer)
 values
